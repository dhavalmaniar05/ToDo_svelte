...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 1, 1, 34);
    			attr_dev(div, "class", "navbar bg-primary svelte-14clgz1");
    ...
    /* src\AddTodo.svelte generated by Svelte v3.44.1 */
    const file$2 = "src\\AddTodo.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "placeholder", "ToDo item");
    			add_location(input0, file$2, 17, 1, 300);
    			attr_dev(input1, "type", "submit");
    			attr_dev(input1, "class", "btn btn-primary btn-sm");
    			input1.value = "Add Player";
    			add_location(input1, file$2, 18, 1, 371);
    			attr_dev(form, "class", "svelte-p80krr");
    			add_location(form, file$2, 16, 0, 270);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*todo*/ ctx[0].todo);
    			append_dev(form, t);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*todo*/ 1 && input0.value !== /*todo*/ ctx[0].todo) {
    				set_input_value(input0, /*todo*/ ctx[0].todo);
    			}
    		},
    		i: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [todo, onSubmit, input0_input_handler];
    }
    ...
    /* src\ToDo.svelte generated by Svelte v3.44.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 11, 1, 244);
    			attr_dev(div, "class", "card");
    			set_style(div, "width", "50%");
    			add_location(div, file$1, 10, 0, 203);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*onDelete*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "No Work Left!!";
    			add_location(p, file, 29, 2, 541);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	todo = new ToDo({
    			props: { todo: /*todo*/ ctx[3].todo },
    			$$inline: true
    		});

    	todo.$on("removetodo", /*removeTodo*/ ctx[2]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const todo_changes = {};
    			if (dirty & /*todos*/ 1) todo_changes.todo = /*todo*/ ctx[3].todo;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:2) {#each todos as todo}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	addtodo.$on("addtodo", /*addTodo*/ ctx[1]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if_block.c();
    			attr_dev(div, "class", "container svelte-igafat");
    			add_location(div, file, 26, 0, 455);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const removeTodo = e => {
    		$$invalidate(0, todos = todos.filter(todo => todo.todo !== e.detail));
    	};
